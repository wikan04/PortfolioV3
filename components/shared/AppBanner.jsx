  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          Frontend Web Developer | React.js · Next.js · TypeScript · Tailwind
          CSS
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <a
            download="Wikan_Dewanto_Martonagoro_CV_ATS.pdf"
            href="/files/Wikan_Dewanto_Martonagoro_CV_ATS.pdf"
      ...
      <motion.div
        ...
        transition={{ ease: "easeInOut", duration: 0.9, delay: 0.2 }}
        className="w-full sm:w-[40%] text-right float-right mt-8 sm:mt-0"
      >
        <Image
          src="/images/wikan.svg"
          width={600}
          height={600}
          alt="Developer"
          className="w-full"
