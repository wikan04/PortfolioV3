  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          An enthusiastic Frontend Web Developer and Data Analyst
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <a
            download="Wikan-Resume-New.pdf"
            href="/files/Wikan-Resume-New.pdf"
      ...
      >
        <img
          layout="responsive"
          src={
            activeTheme === "dark" ? "/images/wikan.svg" : "/images/wikan.svg"
          }
          alt="Developer"
        />
      </motion.div>
