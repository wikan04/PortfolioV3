...
function ProjectsGrid() {
  // Inisialisasi state searchProject sebagai string kosong
  const [searchProject, setSearchProject] = useState("");
  const [selectProject, setSelectProject] = useState();

  // Filter untuk pencarian berdasarkan title
  ...
  // Jangan diubah karena selectProject sudah bekerja dengan baik
